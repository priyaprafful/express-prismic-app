 ...
 */
declare type TitleField = [
    RTHeading1Node | RTHeading2Node | RTHeading3Node | RTHeading4Node | RTHeading5Node | RTHeading6Node
];
declare type RichTextField = RTNode[];
/**
 ...
 */
declare type ImageField<ThumbnailNames extends string = string> = ImageFieldImage & Record<ThumbnailNames, ImageFieldImage>;
/**
 * Link Types
 */
 ...
 */
declare type EmptyLinkField<Type extends LinkType = LinkType.Any> = {
    link_type: Type | string;
};
/**
 * Links that refer to Documents
 */
interface FilledLinkToDocumentField<TypeEnum = string, LangEnum = string, DataInterface = never> {
 ...
 */
declare type RelationField<TypeEnum = string, LangEnum = string, DataInterface = never> = FilledLinkToDocumentField<TypeEnum, LangEnum, DataInterface> | EmptyLinkField<LinkType.Document>;
/**
 * Link Field
 */
declare type LinkField<TypeEnum = string, LangEnum = string, DataInterface = never> = RelationField<TypeEnum, LangEnum, DataInterface> | FilledLinkToWebField | LinkToMediaField | EmptyLinkField<LinkType.Any>;
/**
